      ...
      <div className="px-8 py-4 bg-blue-50/30 border-b border-blue-100/50 flex items-start gap-3">
        ...
        {aiThought && (
            <button
                ...
                className={`p-2.5 rounded-xl border transition-all relative top-0.5 focus:outline-none ${showThought ? 'bg-yellow-100 border-yellow-200 text-yellow-700' : 'bg-white border-blue-100 text-gray-400 hover:text-yellow-600 hover:bg-yellow-50'}`}
