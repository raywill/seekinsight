...
import { Database, Play, RefreshCcw, Code2, RotateCcw, Lightbulb, ArrowUp } from 'lucide-react';
...
interface Props {
  ...
  previewResult?: ExecutionResult | null; 
  onRun: () => void;
  isExecuting: boolean;
...
const SqlWorkspace: React.FC<Props> = ({ 
  ...
  const handleToggleThought = () => {
      ...
      if (!showThought) setHasUnreadThought(false);
  };
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-white relative">
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden">
        ...
        {isUndoVisible && (
          <div className="absolute top-4 right-6 z-20 animate-in fade-in slide-in-from-top-2 duration-300 pointer-events-auto">
            <button 
